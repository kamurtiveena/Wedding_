function onLoad() {
    ...
    fetch('assets/conversation.json')
        ...
        .then(data => {
            ...
            function displayButtons(buttons) {
                ...
                buttons.forEach(button => {
                    ...
                    buttonElement.className = "mesage-button";
                ...
                if (currentStep < data.length) {
                    ...
                    if (step.hasOwnProperty("image")) {
                        for (let i = 0; i < step.image.length; i++) {
                            setTimeout(function () {
                                displayMessage(step,"<img src='" + step.image[i] + "' onclick='openFullScreenImage(this)' style='max-width: 100%; height: auto; display: block; overflow: hidden;'>"
                                ,i,step.image.length)
                            }, (i + 1) * 1500);
                        }
                    }
